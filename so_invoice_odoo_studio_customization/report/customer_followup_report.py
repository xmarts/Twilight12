...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        headers = [{},
                   ...
                   {'name': _('Project'), 'style': 'text-align:center; white-space:nowrap;'},
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                columns = [
                    ...
                    date_due,
                    aml.invoice_id.project_id_from_so.name,
            ...
            lines.append({
                ...
                'unfoldable': False,
                'level': 0,
                'columns': [{'name': v} for v in [''] * (4 if self.env.context.get('print_mode') else 5) + [total >= 0 and _('Total Due') or '', total_due]],
            })
            if total_issued > 0:
